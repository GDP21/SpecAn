...
******************************************************************************
 ...
 \n<b>Description:</b>\n
         This file contains the common structures and defines for the
		 MobileTV DACOMMS API.
...
******************************************************************************
 ...
 $Log: dacomms_api.h,v $
 Revision 1.2  2009/07/28 16:12:02  sue.brace
 include code for data over USB, increase response buffer sixe

 Revision 1.1  2009/02/16 15:43:08  michael.melbourne
 Initial version

 Revision 1.5  2008/07/07 16:49:23  mja
 Changed async payload size to 32K

 Revision 1.4  2008/06/19 14:34:22  mja
 Added various defines for different tarantino chips/host OS's.

 Revision 1.3  2008/04/21 14:30:22  mja
 Fixed line endings.

 Revision 1.2  2008/03/11 14:54:47  mja
 Sets of buffers are now generalised as groups instead of pairs.
 Reduced the size of ACK/NACK messages and removed CRCing from them.

 Revision 1.1  2008/03/10 10:50:21  mja
 First checkin. This file contains elements shared between host and device COMMS modules.
...
#define DACOMMS_VARIANT						(DACOMMS_DASH)
...
// SDIO specific
	...
	#if SDIO_64BYTE_BUG == 1
		#define SDIO_OSCAR_XP_LIMIT		(64)
	#endif
