/*
** FILE NAME:   $Source: /cvs/mobileTV/support/common/tuners/msi_tuner/source/generic/msi_spim_giodrv.c,v $
**
...
**              This version uses IMGWorks Generic IO peripheral drivers
**
...
#define SPIM_BIT_RATE (0x32)

/* SPIM port */
static SPIM_sBlock msiSpimPort;
...
int MSI_setupPort(int dmacChannel, int portNumber)
{
	...
	switch(portNumber)
	{			/* Port number maps to CS on SPIM port 0 */
		case(0):
    ...
    initParam.sDev0Param.ui8BitRate = SPIM_BIT_RATE;
    ...
    initParam.sDev1Param.ui8BitRate = SPIM_BIT_RATE;
    ...
    initParam.sDev2Param.ui8BitRate = SPIM_BIT_RATE;
    ...
    initParam.ui32BlockIndex = 0;	/* Always use SPIM0 */
