...
static const ShiftLUT SHIFT_LUT8[]=
{
	{331000000, 0x18, 0x04},
	{338000000, 0x2C, 0x04},
	{339000000, 0xB4, 0x07},
...
static const ShiftLUT SHIFT_LUT6[]=
{
	{339000000, 0xD4, 0x07},
	{345000000, 0x2C, 0x04},
	{357000000, 0x2C, 0x04},
...
MxL_ERR_MSG MxL_Tuner_RFTune(MxL201RF_TunerConfigS* myTuner, UINT32 RF_Freq_Hz, MxL201RF_BW_MHz BWMHz)
{
	...
	/* Make sure the passed BW is a member of MxL201RF_BW_MHz */
	...
	if(myTuner->Xtal_Freq == MxL_XTAL_24_MHZ)
	{
		...
		{
			while(SHIFT_LUT8[counter].Ch_Freq_Hz != 0)
			{
		...
		{
			while(SHIFT_LUT6[counter].Ch_Freq_Hz != 0)
			{
